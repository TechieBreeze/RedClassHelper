...
class _DataState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalQuestions =
        stats.fold<int>(0, (s, b) => s + b.totalQuestions);
    final totalAttempts =
        stats.fold<int>(0, (s, b) => s + b.totalAttempts);
    final totalCorrect =
        stats.fold<int>(0, (s, b) => s + b.correctCount);
    final overallRate =
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _HeroMiniStat(
                              label: '答题次数', value: '$totalAttempts'),
                          _HeroMiniStat(
                              label: '答对', value: '$totalCorrect'),
                        ],
                      ),
                    ],
                  ),
